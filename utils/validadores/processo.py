...
from .numero_decreto import validar_numero_decreto
...
def validar_processamento_campos(numero_processo, valor_input, objetivo, data_recebimento, data_publicacao, numero_decreto):
    ...
    if numero_decreto and not validar_numero_decreto(numero_decreto):
        erros.append("❌ Número do decreto inválido. Use o formato: 000.000")
